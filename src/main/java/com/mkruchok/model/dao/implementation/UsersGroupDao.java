...
public final class UsersGroupDao implements AbstractDao<UsersGroup> {

  static final Logger LOGGER = LoggerFactory.getLogger(UsersGroupDao.class);
  private static final String GET_ALL = "SELECT * FROM ajax_curr.users_group";
  private static final String GET_BY_ID = "SELECT * FROM ajax_curr.users_group WHERE id=?";
